package com.pifachry.pesonagunungindonesia.ui.adapter
...
import com.pifachry.pesonagunungindonesia.ui.DetailGunung
import com.pifachry.pesonagunungindonesia.utils.Gunung

class ListGunungAdapter (private val listMountain: ArrayList<Gunung>) : RecyclerView.Adapter<ListGunungAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ListViewHolder {
        val view: View = LayoutInflater.from(viewGroup.context).inflate(R.layout.item_row_gunung, viewGroup, false)
